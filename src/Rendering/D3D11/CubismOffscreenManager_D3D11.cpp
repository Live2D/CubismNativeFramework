...
CubismOffscreenManager_D3D11::CubismOffscreenManager_D3D11()
{
}
...
CubismRenderTarget_D3D11* CubismOffscreenManager_D3D11::GetOffscreenRenderTarget(ID3D11Device* device, csmUint32 width, csmUint32 height)
{
    // 使用数を更新
    UpdateRenderTargetCount();

    // 使われていないリソースコンテナがあればそれを返す
    CubismRenderTarget_D3D11* offscreenRenderTarget = GetUnusedOffscreenRenderTarget();
