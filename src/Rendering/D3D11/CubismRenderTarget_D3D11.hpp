 ...
 * @brief  レンダーターゲット用クラス
 */
class CubismRenderTarget_D3D11 : public CubismRenderTarget<CubismRenderTarget_D3D11>
{
public:
    /**
     ...
     * @param   dst[in]             コピー先
     */
    static void CopyBuffer(ID3D11DeviceContext* renderContext, CubismRenderTarget_D3D11& src, CubismRenderTarget_D3D11& dst);

    /**
     * @brief   コンストラクタ
     *
     */
    CubismRenderTarget_D3D11();
     ...
     */
    csmBool CreateRenderTarget(ID3D11Device* device, csmUint32 displayBufferWidth, csmUint32 displayBufferHeight);
