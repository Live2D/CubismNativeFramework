...
VS_OUT VertNormalBlend(VS_IN In) {
    ...
    Out.blendUv = AlignPixel(Out.blendUv);
    return Out;
}
...
float4 Pixel ## MASK ## Blend ## COLOR ## ALPHA(VS_OUT In) : COLOR0 { \
...
// Technique
technique ShaderNames_Copy {
    pass p0 {
        VertexShader = compile vs_2_0 VertCopy();
        PixelShader = compile ps_2_0 PixelCopy();
    }
}

#define CSM_CREATE_TECHNIQUE(MASK_NAME, VERT, MASK, COLOR, ALPHA) \
technique ShaderNames_ ## MASK_NAME ## Blend_ ## COLOR ## ALPHA { \
    pass p0 { \
        VertexShader = compile vs_3_0 VERT(); \
        PixelShader = compile ps_3_0 Pixel ## MASK ## Blend ## COLOR ## ALPHA(); \
    } \
}

#define CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, COLOR) \
CSM_CREATE_TECHNIQUE(MASK_NAME, VERT, MASK, COLOR, Over) \
\
CSM_CREATE_TECHNIQUE(MASK_NAME, VERT, MASK, COLOR, Atop) \
\
CSM_CREATE_TECHNIQUE(MASK_NAME, VERT, MASK, COLOR, Out) \
\
CSM_CREATE_TECHNIQUE(MASK_NAME, VERT, MASK, COLOR, ConjointOver) \
\
...
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, AddGlow) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, Darken) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, Multiply) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, ColorBurn) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, LinearBurn) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, Lighten) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, Screen) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, ColorDodge) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, Overlay) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, SoftLight) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, HardLight) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, LinearLight) \
\
CSM_CREATE_BLEND_OVERLAP_TECHNIQUE(MASK_NAME, VERT, MASK, Hue) \
\
...
// masked inverted
CSM_CREATE_BLEND_MODE_TECHNIQUE(MaskedInverted, VertMaskedBlend, MaskedInverted)

// normal premult alpha
CSM_CREATE_BLEND_MODE_TECHNIQUE(NormalPremultipliedAlpha, VertMaskedBlend, NormalPremult)

// masked premult alpha
CSM_CREATE_BLEND_MODE_TECHNIQUE(MaskedPremultipliedAlpha, VertMaskedBlend, MaskedPremult)

// masked inverted premult alpha
CSM_CREATE_BLEND_MODE_TECHNIQUE(MaskedInvertedPremultipliedAlpha, VertMaskedBlend, MaskedInvertedPremult)

#undef CSM_CREATE_BLEND_MODE_TECHNIQUE
#undef CSM_CREATE_BLEND_OVERLAP_TECHNIQUE
#undef CSM_CREATE_TECHNIQUE
